...
1. Familiarize yourself with our contributing guide:
	* https://github.com/xaxvss/desktop/blob/development/.github/CONTRIBUTING.md#contributing-to-github-desktop
2. Check if your issue (and sometimes workaround) is in the known-issues doc:
	* https://github.com/xaxvss/desktop/blob/development/docs/known-issues.md
...
https://github.com/xaxvss/desktop/blob/development/docs/contributing/timeline-profile.md
-->
