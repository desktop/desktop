...
/**
 * Test a patch against the repository at the expected location to see if it
 * will apply cleanly.
 *
 * @param workTree work tree which should be checked out to the right base commit
 * @param patch the raw patch generated by Git to test
 */
