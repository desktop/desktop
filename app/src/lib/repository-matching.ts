...
export function matchGitHubRepository(users: ReadonlyArray<Account>, remote: string): GitHubRepository | null {
...
function matchRemoteWithUser(user: Account, remote: string): GitHubRepository | null {
