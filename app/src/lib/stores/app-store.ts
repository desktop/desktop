...
import { groupLogMessages } from '../../ui/lib/group-log-messages'
...
export class AppStore extends TypedBaseStore<IAppState> {
  ...
  private async _selectRepositoryRefreshTasks(
    ...
    this._refreshRepository(repository, 'refresh tasks')
  ...
  private startBackgroundPruner(repository: Repository) {
    ...
    if (enableBranchPruning()) {
      const pruner = new BranchPruner(
        ...
        repository => this._refreshRepository(repository, 'branch pruner done')
      )
  ...
  public async _commitIncludedChanges(
    ...
    if (result) {
      ...
      await this._refreshRepository(repository, 'commit included changes')
  ...
  public async _refreshRepository(
    ...
    const disposable = groupLogMessages(`refresh - '${label}'`)
  ...
  public async _checkoutBranch(
    ...
    try {
      ...
      await this._refreshRepository(repository, 'checkout branch')
    } finally {
  ...
  public async _renameBranch(
    ...
    return this._refreshRepository(repository, 'rename branch')
  }
  ...
  public async _deleteBranch(
    ...
    return this.withAuthenticatingUser(repository, async (r, account) => {
      ...
      return this._refreshRepository(r, 'delete branch')
    })
  }
      ...
      if (tip.kind === TipState.Valid) {
        ...
        await gitStore.performFailableOperation(
          async () => {
            ...
            await this._refreshRepository(repository, 'push')
    ...
    return this.withPushPullFetch(repository, async () => {
      ...
      if (tip.kind === TipState.Valid) {
        ...
        try {
          ...
          await this._refreshRepository(repository, 'pull')
  ...
  public async _discardChanges(
    ...
    return this._refreshRepository(repository, 'discard changes')
  }
  ...
  public async _undoCommit(
    ...
    return this._refreshRepository(repository, 'undo commit')
  }
  ...
  public async _fetchRefspec(
    ...
    return this.withAuthenticatingUser(
      ...
      async (repository, account) => {
        ...
        return this._refreshRepository(repository, 'fetch refspec')
      }
    )
  }
  ...
  private async performFetch(
    ...
    await this.withPushPullFetch(repository, async () => {
      ...
      try {
        ...
        await this._refreshRepository(repository, 'fetch')
  ...
  public async _mergeBranch(
    ...
    return this._refreshRepository(repository, 'merge branch')
  }
  ...
  public async _saveGitIgnore(
    ...
    return this._refreshRepository(repository, 'save gitignore')
  }
  ...
  public async _appendIgnoreRule(
    ...
    return this._refreshRepository(repository, 'append to gitignore')
  }
  ...
  public async _revertCommit(
    ...
    return this.withAuthenticatingUser(repository, async (repo, account) => {
      ...
      await this._refreshRepository(repository, 'revert commit')
    })
  }
  ...
  public async _updateExistingUpstreamRemote(
    ...
    return this._refreshRepository(repository, 'update upstream remote')
  }
  ...
  public async _createStash(
    ...
    await this._refreshRepository(repository, 'create stash')
  }
  ...
  public async _popStashEntry(repository: Repository, stashEntry: IStashEntry) {
    ...
    await this._refreshRepository(repository, 'pop stash')
  }
