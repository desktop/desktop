...
export class AppStore extends TypedBaseStore<IAppState> {
  ...
  private async _selectRepositoryRefreshTasks(
    ...
    this.refreshRepository(repository, 'refresh tasks')
  ...
  private startBackgroundPruner(repository: Repository) {
    ...
    if (enableBranchPruning()) {
      const pruner = new BranchPruner(
        ...
        repository => this.refreshRepository(repository, 'branch pruning done')
      )
  ...
  public async _commitIncludedChanges(
    ...
    if (result) {
      ...
      await this.refreshRepository(repository, '_commitIncludedChanges')
    ...
    if (repository.missing) {
      ...
      if (!updatedRepository.missing) {
        ...
        return this.refreshRepository(
          repository,
          '_refreshOrRecoverRepository (1)'
        )
      }
    } else {
      return this.refreshRepository(
        repository,
        '_refreshOrRecoverRepository (2)'
      )
    }
  }
  ...
  public async refreshRepository(repository: Repository, label: string) {
    console.group(`refresh for ${label}`)
  ...
  public async _checkoutBranch(
    ...
    try {
      ...
      await this.refreshRepository(repository, '_checkoutBranch')
    } finally {
  ...
  public async _renameBranch(
    ...
    return this.refreshRepository(repository, '_renameBranch')
  }
  ...
  public async _deleteBranch(
    ...
    return this.withAuthenticatingUser(repository, async (r, account) => {
      ...
      return this.refreshRepository(r, '_deleteBranch')
    })
  }
      ...
      if (tip.kind === TipState.Valid) {
        ...
        await gitStore.performFailableOperation(
          async () => {
            ...
            await this.refreshRepository(repository, 'performPush')
    ...
    return this.withPushPullFetch(repository, async () => {
      ...
      if (tip.kind === TipState.Valid) {
        ...
        try {
          ...
          await this.refreshRepository(repository, 'performPull')
  ...
  public async _discardChanges(
    ...
    return this.refreshRepository(repository, '_discardChanges')
  }
  ...
  public async _undoCommit(
    ...
    return this.refreshRepository(repository, '_undoCommit')
  }
  ...
  public async _fetchRefspec(
    ...
    return this.withAuthenticatingUser(
      ...
      async (repository, account) => {
        ...
        return this.refreshRepository(repository, '_fetchRefspec')
      }
    )
  }
  ...
  private async performFetch(
    ...
    await this.withPushPullFetch(repository, async () => {
      ...
      try {
        ...
        await this.refreshRepository(repository, 'performFetch')
  ...
  public async _mergeBranch(
    ...
    return this.refreshRepository(repository, '_mergeBranch')
  }
  ...
  public async _saveGitIgnore(
    ...
    return this.refreshRepository(repository, '_saveGitIgnore')
  }
  ...
  public async _appendIgnoreRule(
    ...
    return this.refreshRepository(repository, '_appendIgnoreRule')
  }
  ...
  public async _revertCommit(
    ...
    return this.withAuthenticatingUser(repository, async (repo, account) => {
      ...
      await this.refreshRepository(repository, '_revertCommit')
    })
  }
  ...
  public async _updateExistingUpstreamRemote(
    ...
    return this.refreshRepository(repository, '_updateExistingUpstreamRemote')
  }
  ...
  public async _popStashEntry(repository: Repository, stashEntry: IStashEntry) {
    ...
    await this.refreshRepository(repository, '_popStashEntry')
  }
