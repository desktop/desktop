...
export class AppStore extends TypedBaseStore<IAppState> {
    ...
    if (enableStashing()) {
      ...
      if (
        ...
        if (
          ...
          const stashCreated = await this.withErrorHandling(repository, () => {
  ...
  public async _rebase(
    ...
    const result = await this.withErrorHandling(repository, () =>
  ...
  public async _moveChangesToBranchAndCheckout(
    ...
    const isStashCreated = await this.withErrorHandling(repository, () => {
