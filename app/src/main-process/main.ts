...
import { fixAllWindowsShortcuts } from '../lib/fix-windows-shortcuts'
...
// On Windows, in order to get notifications properly working, we'll want to set
// the right App User Model ID from production builds for dev builds, and also
// fix the shortcuts generated by Squirrel.
if (__WIN32__) {
  if (__DEV__) {
    app.setAppUserModelId('com.squirrel.GitHubDesktop.GitHubDesktop')
  }

  fixAllWindowsShortcuts()
}
