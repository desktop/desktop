...
/**
 * The visual representation of the diff of a file
 */
export class ImageDiff {

  /**
   * The previous state of the image
   */
  public readonly previous: Image | undefined

  /**
   * The current state of the image
   */
  public readonly current: Image | undefined
}
