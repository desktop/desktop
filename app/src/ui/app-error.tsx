    ...
    if (unhandled) {
      ...
      return (
        <div>
          ...
          <p>
            This has been reported to the team, but if you encounter this repeatedly please report this issue to the
            <LinkButton uri='https://github.com/desktop/desktop'>GitHub Desktop</LinkButton> repository.
          </p>
          {errorDetails}
