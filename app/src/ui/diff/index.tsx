...
import { CodeMirrorHost } from './text/code-mirror-host'
...
import { IEditorConfigurationExtra } from './text/editor-configuration-extra'
import { getDiffMode } from './text/diff-mode'
