  ...
  public render() {
    return (
      ...
      >
        <DialogContent>
          <p>
            You&apos;ve been using Copilot to resolve conflicts. Would you like
            to automatically start with Copilot whenever conflicts are detected?
          </p>
          <p>
            Copilot will still resolve this conflict regardless of your choice.
        ...
        <DialogFooter>
          <OkCancelButtonGroup
            okButtonText={__DARWIN__ ? 'Yes' : 'Yes'}
            cancelButtonText={__DARWIN__ ? 'No' : 'No'}
