...
export class OcticonSymbol {
  ...
  public static get archive() {
    return new OcticonSymbol(
      14,
      16,
      'M13 2H1v2h12V2zM0 4a1 1 0 001 1v9a1 1 0 001 1h10a1 1 0 001-1V5a1 1 0 001-1V2a1 1 0 00-1-1H1a1 1 0 00-1 1v2zm2 1h10v9H2V5zm2 3h6V7H4v1z'
    )
  }
  ...
  public static get githubAction() {
    return new OcticonSymbol(
      16,
      16,
      'M9 2h6c.55 0 1 .45 1 1v10c0 .55-.45 1-1 1H9a1 1 0 11-2 0H1c-.55 0-1-.45-1-1V3c0-.55.45-1 1-1h6a1 1 0 112 0zm6 1v10H1V3h14zm-2.5 4a1.5 1.5 0 100-3 1.5 1.5 0 000 3z'
    )
  }
  ...
  public static get internalRepo() {
    return new OcticonSymbol(
      13,
      16,
  ...
  public static get kebabHorizontal() {
    return new OcticonSymbol(
      13,
      16,
      'M1.5 9a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm5 0a1.5 1.5 0 100-3 1.5 1.5 0 000 3zM13 7.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z'
    )
  }
  ...
  public static get lineArrowDown() {
    return new OcticonSymbol(
      16,
      16,
      'M4.5 7.5L3 9l5 5 5-5-1.5-1.5L9 10.179V2H7v8.179L4.5 7.5z'
    )
  }
  public static get lineArrowLeft() {
    return new OcticonSymbol(
      16,
      16,
      'M8.5 4.5L7 3 2 8l5 5 1.5-1.5L5.821 9H14V7H5.821L8.5 4.5z'
    )
  }
  public static get lineArrowRight() {
    return new OcticonSymbol(
      16,
      16,
      'M7.5 11.5L9 13l5-5-5-5-1.5 1.5L10.179 7H2v2h8.179L7.5 11.5z'
    )
  }
  public static get lineArrowUp() {
    return new OcticonSymbol(
      16,
      16,
  ...
  public static get play() {
    return new OcticonSymbol(
      14,
      16,
      'M14 8A7 7 0 110 8a7 7 0 0114 0zm-8.223 3.482l4.599-3.066a.5.5 0 000-.832L5.777 4.518A.5.5 0 005 4.934v6.132a.5.5 0 00.777.416z'
    )
  }
  ...
  public static get primitiveDotStroke() {
    return new OcticonSymbol(
      8,
      16,
      'M4 10.5a2.5 2.5 0 100-5 2.5 2.5 0 000 5zM4 12a4 4 0 100-8 4 4 0 000 8z'
    )
  }
  ...
  public static get project() {
    return new OcticonSymbol(
      15,
      16,
      'M10 12h3V2h-3v10zm-4-2h3V2H6v8zm-4 4h3V2H2v12zm-1 1h13V1H1v14zM14 0H1a1 1 0 00-1 1v14a1 1 0 001 1h13a1 1 0 001-1V1a1 1 0 00-1-1z'
    )
  }
  ...
  public static get report() {
    return new OcticonSymbol(
      16,
      16,
      'M0 2a1 1 0 011-1h14a1 1 0 011 1v9a1 1 0 01-1 1H7l-4 4v-4H1a1 1 0 01-1-1V2zm1 0h14v9H6.5L4 13.5V11H1V2zm6 6h2v2H7V8zm0-5h2v4H7V3z'
    )
  }
  ...
  public static get saved() {
    return new OcticonSymbol(
      16,
      16,
      'M12 0H4c-.73 0-1 .27-1 1v15l5-3.09L13 16V1c0-.73-.27-1-1-1z'
    )
  }
  ...
  public static get skip() {
    return new OcticonSymbol(
      16,
      16,
      'M5.79 11.624l-1.326-.088-.088-1.326 5.834-5.834 1.326.088.088 1.326-5.834 5.834zM8 15A7 7 0 108 1a7 7 0 000 14zm5.5-7a5.5 5.5 0 11-11 0 5.5 5.5 0 0111 0z'
    )
  }
  ...
  public static get unsaved() {
    return new OcticonSymbol(
      16,
      16,
      'M12 0H4c-.73 0-1 .27-1 1v1.982l10 5.774V1c0-.73-.27-1-1-1zm1 12.203l1.606.928.75-1.3-13.856-8-.75 1.3L3 6.43V16l5-3.09L13 16v-3.797z'
    )
  }
  ...
  public static get workflow() {
    return new OcticonSymbol(
      16,
      16,
      'M3 4.949a2.5 2.5 0 10-1 0v8.049c0 .547.453 1 1 1h2.05a2.5 2.5 0 004.9 0h1.1a2.5 2.5 0 100-1h-1.1a2.5 2.5 0 00-4.9 0H3v-5h2.05a2.5 2.5 0 004.9 0h1.1a2.5 2.5 0 100-1h-1.1a2.5 2.5 0 00-4.9 0H3v-2.05zm9 2.55a1.5 1.5 0 103 0 1.5 1.5 0 00-3 0zm-3 0a1.5 1.5 0 10-3 0 1.5 1.5 0 003 0zm4.5 7.499a1.5 1.5 0 110-3.001 1.5 1.5 0 010 3zm-6-3a1.5 1.5 0 110 3 1.5 1.5 0 010-3z'
    )
  }
  public static get workflowAll() {
    return new OcticonSymbol(
      16,
      16,
      'M10 8A5 5 0 110 8a5 5 0 0110 0zM3.5 5.5l4 2.5-4 2.5v-5zm3.75 7.444a5.001 5.001 0 000-9.888 5 5 0 110 9.888zm3 0a5.001 5.001 0 000-9.888 5 5 0 110 9.888z'
    )
  }
  public static get x() {
    return new OcticonSymbol(
