...
interface IInitializeSubmodulesProps {
...
export class InitializeSubmodules extends React.Component<
  IInitializeSubmodulesProps,
  {}
> {
  public render() {
    return (
      <Dialog
        ...
        title="Initialize Git Submodules"
      ...
      >
        ...
        <DialogFooter>
          <ButtonGroup>
            <Button type="submit">Initialize Git Submodules</Button>
    ...
    if (this.props.repositories.length > MaxRepositoriesToList) {
      return (
        <p>
          ...
          <LinkButton uri={SUBM_URL}>Git Submodules</LinkButton>. To contribute
          to them, Git Submodules must first be initialized. Would you like to
          do so now?
        </p>
      )
    } else {
      ...
      return (
        <div>
          <p>
            ...
            <LinkButton uri={SUBM_URL}>Git Submodules</LinkButton>. To
            contribute to {pluralizedUse}, Git Submodules must first be
