...
describe('Branches grouping', () => {
  const currentBranch = new Branch('master', null, '', null, BranchType.Local)
  const defaultBranch = new Branch('master', null, '', null, BranchType.Local)
  const recentBranches = [
    new Branch('some-recent-branch', null, '', null, BranchType.Local),
  ]
  const otherBranch = new Branch('other-branch', null, '', null, BranchType.Local)
