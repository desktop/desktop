...
*Windows only: Make sure you allow the Node.js installer to add node to the PATH, it'll make life much easier for you. Also, make sure you're on Node 3.10.4 or higher. You can check via `npm -v`. If not, run `npm install -g npm`*
