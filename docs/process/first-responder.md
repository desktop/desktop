...
1. Triage issues.
    ...
    * Review issues labelled [`reviewer-needs-to-reproduce`](https://github.com/desktop/desktop/issues?q=is%3Aopen+is%3Aissue+sort%3Aupdated-asc+label%3Aneeds-reproduction) and close any that have gone 2 weeks with no new activity after the last question by a reviewer.
